...
public class SmartLibrarySystem {
    ...
    // Book is abstract — every child class must provide its own book type and full-detail display
    // Method overriding: PrintedBook and EBook provide their own getType() and displayDetails()
    static abstract class Book {
        // All book data is private — encapsulation
        private String id;
        private String ti;
        private String au;
        private String pu;
        ...
        public String getPublisher() { return pu; }
        public String getIsbn() { return is; }
        public String getCategory() { return ca; }
        public double getPrice() { return pr; }
        public int getPages() { return pg; }
        public int getYear() { return yr; }
        public boolean isAvailable() { return av; }

        public void setTitle(String ti) { this.ti = ti; }
        public void setAuthor(String au) { this.au = au; }
        public void setPublisher(String pu) { this.pu = pu; }
        public void setIsbn(String is) { this.is = is; }
        public void setCategory(String ca) { this.ca = ca; }

        public void setPrice(double pr) {
            if (isValidPrice(pr)) { this.pr = pr; }
        }

        public void setPages(int pg) {
            if (isValidPages(pg)) { this.pg = pg; }
        }
